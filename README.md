...
<p align="center">
  <a href="https://github.com/RaafaPimentel?tab=repositories"><img src="https://img.shields.io/badge/Portfolio-GitHub-181717?logo=github" alt="GitHub portfolio" /></a>
  <img src="https://img.shields.io/badge/Focus-Shift--Left%20Testing-blue" alt="Shift-left testing" />
  <img src="https://img.shields.io/badge/Automation-TypeScript%20%7C%20Python%20%7C%20API-green" alt="Automation stack" />
  <img src="https://img.shields.io/badge/AI-LLM%20Assisted%20QA-purple" alt="LLM assisted QA" />
</p>
...
```mermaid
flowchart LR
    A[Requirement or architecture change] --> B[Risk analysis]
    B --> C[Test strategy]
    C --> D[API and contract checks]
    C --> E[E2E user journeys]
    C --> F[Integration and data validation]
    D --> G[CI quality gates]
    E --> G
    F --> G
    G --> H[Test reports, logs, traces, and evidence]
    H --> I[Release confidence]
```
...
<p align="center">
  <img height="165" src="https://github-readme-stats.vercel.app/api?username=RaafaPimentel&show_icons=true&hide_border=true&include_all_commits=true&count_private=false" alt="Rafa Pimentel GitHub stats" />
  <img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=RaafaPimentel&layout=compact&hide_border=true" alt="Rafa Pimentel top languages" />
</p>
